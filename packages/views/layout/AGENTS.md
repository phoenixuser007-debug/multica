...
## Purpose
Layout view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `app-sidebar.tsx` | Source file local to this directory. |
| `dashboard-guard.tsx` | Source file local to this directory. |
| `dashboard-layout.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `use-dashboard-guard.ts` | Source file local to this directory. |
