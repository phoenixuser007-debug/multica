...
| File | Description |
| --- | --- |
| `agent-detail.tsx` | Source file local to this directory. |
| `agent-list-item.tsx` | Source file local to this directory. |
| `agents-page.tsx` | Source file local to this directory. |
| `create-agent-dialog.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |

## Subdirectories
| Directory | Purpose |
| --- | --- |
| `tabs/` | Tabs view module containing UI composition for that feature area. See `tabs/AGENTS.md`. |
