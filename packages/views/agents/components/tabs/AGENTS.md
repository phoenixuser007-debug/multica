...
## Purpose
Tabs view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `instructions-tab.tsx` | Source file local to this directory. |
| `settings-tab.tsx` | Source file local to this directory. |
| `skills-tab.tsx` | Source file local to this directory. |
| `tasks-tab.tsx` | Source file local to this directory. |
