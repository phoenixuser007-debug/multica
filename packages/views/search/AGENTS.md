...
## Purpose
Search view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `index.ts` | Barrel export for the directory or package. |
| `search-command.test.tsx` | Unit test for the local module. |
| `search-command.tsx` | Source file local to this directory. |
| `search-store.ts` | Source file local to this directory. |
| `search-trigger.tsx` | Source file local to this directory. |
