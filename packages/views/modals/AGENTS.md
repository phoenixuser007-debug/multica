...
## Purpose
Modals view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `create-issue.tsx` | Source file local to this directory. |
| `create-workspace.tsx` | Source file local to this directory. |
| `registry.tsx` | Source file local to this directory. |
