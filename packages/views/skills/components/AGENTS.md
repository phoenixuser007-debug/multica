...
| File | Description |
| --- | --- |
| `file-tree.tsx` | Source file local to this directory. |
| `file-viewer.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `skills-page.tsx` | Source file local to this directory. |
