...
| File | Description |
| --- | --- |
| `inbox-detail-label.tsx` | Source file local to this directory. |
| `inbox-list-item.tsx` | Source file local to this directory. |
| `inbox-page.tsx` | Source file local to this directory. |
