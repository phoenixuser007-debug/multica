...
## Purpose
Issues view module containing UI composition for that feature area.
...
| `hooks/` | Hooks view module containing UI composition for that feature area. See `hooks/AGENTS.md`. |
