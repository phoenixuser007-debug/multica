...
| File | Description |
| --- | --- |
| `*.ts` | 1 file with the .ts extension. |
| `*.tsx` | 21 files with the .tsx extension. |

## Subdirectories
| Directory | Purpose |
| --- | --- |
| `pickers/` | Pickers view module containing UI composition for that feature area. See `pickers/AGENTS.md`. |
