...
## Purpose
Pickers view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `assignee-picker.tsx` | Source file local to this directory. |
| `due-date-picker.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `priority-picker.tsx` | Source file local to this directory. |
| `property-picker.tsx` | Source file local to this directory. |
| `status-picker.tsx` | Source file local to this directory. |
