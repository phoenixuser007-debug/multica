...
## Purpose
Extensions view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `code-block-view.tsx` | Source file local to this directory. |
| `file-card.tsx` | Source file local to this directory. |
| `file-upload.ts` | Source file local to this directory. |
| `image-view.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `markdown-paste.ts` | Source file local to this directory. |
| `mention-extension.ts` | Source file local to this directory. |
| `mention-suggestion.tsx` | Source file local to this directory. |
| `mention-view.tsx` | Source file local to this directory. |
| `submit-shortcut.ts` | Source file local to this directory. |
