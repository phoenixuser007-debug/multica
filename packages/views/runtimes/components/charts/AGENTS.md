...
## Purpose
Charts view module containing UI composition for that feature area.

## Key Files
| File | Description |
| --- | --- |
| `activity-heatmap.tsx` | Source file local to this directory. |
| `daily-cost-chart.tsx` | Source file local to this directory. |
| `daily-token-chart.tsx` | Source file local to this directory. |
| `hourly-activity-chart.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `model-distribution-chart.tsx` | Source file local to this directory. |
