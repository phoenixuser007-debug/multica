...
## Purpose
Shared config core module that packages reusable domain logic for the monorepo.

## Key Files
| File | Description |
| --- | --- |
| `index.ts` | Barrel export for the directory or package. |
| `priority.ts` | Source file local to this directory. |
| `status.ts` | Source file local to this directory. |
