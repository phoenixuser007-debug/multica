...
## Purpose
Shared issues core module that packages reusable domain logic for the monorepo.
...
| `store.ts` | Source file local to this directory. |
| `ws-updaters.ts` | Source file local to this directory. |

## Subdirectories
| Directory | Purpose |
| --- | --- |
| `config/` | Shared config core module that packages reusable domain logic for the monorepo. See `config/AGENTS.md`. |
| `stores/` | Shared stores core module that packages reusable domain logic for the monorepo. See `stores/AGENTS.md`. |
