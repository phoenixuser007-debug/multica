...
## Purpose
Shared platform core module that packages reusable domain logic for the monorepo.

## Key Files
| File | Description |
| --- | --- |
| `auth-initializer.tsx` | Source file local to this directory. |
| `core-provider.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `persist-storage.test.ts` | Unit test for the local module. |
| `persist-storage.ts` | Source file local to this directory. |
| `storage-cleanup.test.ts` | Unit test for the local module. |
| `storage-cleanup.ts` | Source file local to this directory. |
| `storage.ts` | Source file local to this directory. |
| `types.ts` | Source file local to this directory. |
| `workspace-storage.test.ts` | Unit test for the local module. |
| `workspace-storage.ts` | Source file local to this directory. |
