...
## Purpose
Shared api core module that packages reusable domain logic for the monorepo.

## Key Files
| File | Description |
| --- | --- |
| `client.ts` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `ws-client.ts` | Source file local to this directory. |
