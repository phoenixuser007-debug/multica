...
## Purpose
Markdown rendering helpers and related UI integration.

## Key Files
| File | Description |
| --- | --- |
| `CodeBlock.tsx` | Source file local to this directory. |
| `index.ts` | Barrel export for the directory or package. |
| `linkify.ts` | Source file local to this directory. |
| `Markdown.tsx` | Source file local to this directory. |
| `mentions.ts` | Source file local to this directory. |
| `StreamingMarkdown.tsx` | Source file local to this directory. |
