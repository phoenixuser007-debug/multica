...
## Purpose
Internal backend package for cli concerns.

## Key Files
| File | Description |
| --- | --- |
| `client_test.go` | Directory-local file. |
| `client.go` | Directory-local file. |
| `config.go` | Directory-local file. |
| `flags.go` | Directory-local file. |
| `output.go` | Directory-local file. |
| `update.go` | Directory-local file. |
