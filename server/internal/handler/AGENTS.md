...
## Purpose
HTTP handlers for product domains and daemon endpoints.

## Key Files
| File | Description |
| --- | --- |
| `*.go` | 26 files with the .go extension. |
...
### Internal
- `server/internal/service/`, `server/internal/realtime/`, and `server/pkg/db/generated/` are common collaborators.
