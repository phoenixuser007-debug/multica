...
## Purpose
Runtime usage accounting and reporting helpers for daemon execution.

## Key Files
| File | Description |
| --- | --- |
| `claude.go` | Directory-local file. |
| `codex_test.go` | Directory-local file. |
| `codex.go` | Directory-local file. |
| `scanner.go` | Directory-local file. |
