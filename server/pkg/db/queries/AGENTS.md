...
## Purpose
SQL query source files used to generate database access code.

## Key Files
| File | Description |
| --- | --- |
| `*.sql` | Multiple SQL files grouped in this directory. |
...
### Internal
- Feeds `server/pkg/db/generated/` after `make sqlc`.
