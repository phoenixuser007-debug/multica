...
- **Local [daemon](/daemon-runtimes)** — you run `multica daemon` on your own machine, and it drives the [AI coding tools](/providers) installed locally. Eight are built in today: [Claude Code](/providers#claude-code), [Codex](/providers#codex), [Cursor](/providers#cursor), [Copilot](/providers#copilot), [Gemini](/providers#gemini), [Kimi](/providers#kimi), [OpenCode](/providers#opencode), [Pi](/providers#pi). Your API keys, toolchain, and code directories stay on your machine.
