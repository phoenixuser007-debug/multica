...
One prerequisite: you already have at least one [AI coding tool](/providers) installed locally ([Claude Code](/providers#claude-code), [Codex](/providers#codex), [Cursor](/providers#cursor), [Copilot](/providers#copilot), [Gemini](/providers#gemini), [Kimi](/providers#kimi), [OpenCode](/providers#opencode), or [Pi](/providers#pi)). The daemon auto-detects them on startup and refuses to start if none are present.
...
- [AI coding tools compared](/providers) — capability differences across the 8 tools
