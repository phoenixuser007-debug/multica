...
3. It spawns the appropriate agent CLI (Claude Code, Codex, GitHub Copilot CLI, Gemini CLI, or OpenCode)
...
| GitHub Copilot CLI | `copilot` | GitHub's terminal coding agent |
