...
- ✅ **Real support** — Claude Code, Copilot, Kimi, OpenCode, Pi
...
- [Providers Matrix](/providers) — capability differences across the 8 AI coding tools (including the exact session-resumption status)
