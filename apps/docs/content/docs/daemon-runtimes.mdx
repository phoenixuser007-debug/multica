...
2. Detects AI coding tools installed on your `PATH` (8 built-in: [Claude Code](/providers#claude-code), [Codex](/providers#codex), [Cursor](/providers#cursor), [Copilot](/providers#copilot), [Gemini](/providers#gemini), [Kimi](/providers#kimi), [OpenCode](/providers#opencode), [Pi](/providers#pi))
...
- [Providers Matrix](/providers) — capability differences across the 8 AI coding tools
