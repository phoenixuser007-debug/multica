  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup to configure, authenticate, and start the daemon. It auto-detects Claude Code, Codex, GitHub Copilot CLI, and OpenCode on your machine \u2014 plug in and go.",
      },
      {
