...
## Purpose
Landing-page specific presentation and localization logic.
...
| Directory | Purpose |
| --- | --- |
| `components/` | UI components used by the landing feature. See `components/AGENTS.md`. |
| `i18n/` | Localization resources and helpers for landing pages. See `i18n/AGENTS.md`. |
