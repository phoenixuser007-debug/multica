...
## Purpose
Marketing and public-facing route group for the web client.
...
| Directory | Purpose |
| --- | --- |
| `about/` | Next.js route segment for about in the web client. See `about/AGENTS.md`. |
| `changelog/` | Next.js route segment for changelog in the web client. See `changelog/AGENTS.md`. |
| `homepage/` | Next.js route segment for homepage in the web client. See `homepage/AGENTS.md`. |
