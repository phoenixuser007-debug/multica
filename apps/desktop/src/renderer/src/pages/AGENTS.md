...
## Purpose
Top-level desktop renderer pages and route screens.

## Key Files
| File | Description |
| --- | --- |
| `issue-detail-page.tsx` | Source file local to this directory. |
| `login.tsx` | Source file local to this directory. |
| `project-detail-page.tsx` | Source file local to this directory. |
