...
## Purpose
Renderer-process workspace used by the desktop shell.

## Key Files
| File | Description |
| --- | --- |
| `index.html` | Directory-local file. |

## Subdirectories
| Directory | Purpose |
| --- | --- |
| `src/` | React renderer source for the desktop client UI. See `src/AGENTS.md`. |
